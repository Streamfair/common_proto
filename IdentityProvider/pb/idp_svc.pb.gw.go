...
import (
	...
	"github.com/Streamfair/common_proto/IdentityProvider/pb/login"
...
func request_IdentityProvider_LoginUserAccount_0(ctx context.Context, marshaler runtime.Marshaler, client IdentityProviderClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq login.LoginUserAccountRequest
	...
	msg, err := client.LoginUserAccount(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_IdentityProvider_LoginUserAccount_0(ctx context.Context, marshaler runtime.Marshaler, server IdentityProviderServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq login.LoginUserAccountRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.LoginUserAccount(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterIdentityProviderHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IdentityProviderServer) error {
	...
	mux.Handle("POST", pattern_IdentityProvider_LoginUserAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.IdentityProvider/LoginUserAccount", runtime.WithHTTPPathPattern("/streamfair/v1/login_user_account"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_IdentityProvider_LoginUserAccount_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_IdentityProvider_LoginUserAccount_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterIdentityProviderHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IdentityProviderClient) error {
	...
	mux.Handle("POST", pattern_IdentityProvider_LoginUserAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.IdentityProvider/LoginUserAccount", runtime.WithHTTPPathPattern("/streamfair/v1/login_user_account"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_IdentityProvider_LoginUserAccount_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
