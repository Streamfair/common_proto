...
func (x *UserAccount) GetAccountType() int32 {
	if x != nil {
...
func (x *UserAccounts) GetAccountType() int32 {
	if x != nil {
		return x.AccountType
	}
	return 0
...
var file_register_user_account_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x05, 0x52,
