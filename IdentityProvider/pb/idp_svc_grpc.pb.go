...
type IdentityProviderClient interface {
	...
	RegisterUserAccount(ctx context.Context, in *register.RegisterUserAccountRequest, opts ...grpc.CallOption) (*register.UserAccount, error)
}
...
func (c *identityProviderClient) RegisterUserAccount(ctx context.Context, in *register.RegisterUserAccountRequest, opts ...grpc.CallOption) (*register.UserAccount, error) {
...
type IdentityProviderServer interface {
	...
	RegisterUserAccount(context.Context, *register.RegisterUserAccountRequest) (*register.UserAccount, error)
...
func (UnimplementedIdentityProviderServer) RegisterUserAccount(context.Context, *register.RegisterUserAccountRequest) (*register.UserAccount, error) {
