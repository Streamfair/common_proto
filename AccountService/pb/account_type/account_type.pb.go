...
func (x *AccountType) GetPermissions() []byte {
	if x != nil {
...
func (x *AccountTypes) GetPermissions() []byte {
	if x != nil {
		return x.Permissions
	}
	return nil
...
var file_account_type_account_type_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x70, 0x65, 0x72,
